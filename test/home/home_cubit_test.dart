    ...
    group('logIn tapped', () {
      ...
      group('validator', () {
        test('Email validation works', () {
          ...
          expect(validate.validateEmail(null),'validator_errors.emailEmpty'.tr());
          expect(validate.validateEmail(''),'validator_errors.emailEmpty'.tr());
          expect(validate.validateEmail('badEmailString'),'validator_errors.emailinvalid'.tr());
          expect(validate.validateEmail('badEmailString@'),'validator_errors.emailinvalid'.tr());
          expect(validate.validateEmail('badEmailString@gmail'),'validator_errors.emailinvalid'.tr());
      ...
      group('login', (){
        ...
        setUp: () {
          ...
          when(() => mockAuthService.currentAuthUser).thenReturn(mockAdminUser);
